...
STATIC_ROOT = os.path.join(PRJ_DIR, 'static_dst')
...
SECRET_KEY = '$i#hokjbo(-+$9gs!j++iy&xlp9a-2_6j4m8or*w5-=-f=gl39'
...
ROOT_URLCONF = 'globetrotting.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'globetrotting.wsgi.application'
